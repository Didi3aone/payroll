...
<head>
    ...
    <title><?php echo (isset($title_tab)) ? $title_tab . " || Dashboard" : "Dashboard"; ?></title>
    <!-- Bootstrap Core CSS -->
    <link href="<?php echo base_url(). ASSETS_PLUGINS; ?>bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <!-- chartist CSS -->
    <link href="<?php echo base_url(). ASSETS_PLUGINS; ?>chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="<?php echo base_url(). ASSETS_CSS; ?>style.css" rel="stylesheet">
    <link href="<?php echo base_url(). ASSETS_CSS; ?>style-modify.css" rel="stylesheet">
    ...
    <link href="<?php echo base_url(). ASSETS_PLUGINS; ?>select2/dist/css/select2.min.css" rel="stylesheet" type="text/css" />
    <link rel="stylesheet" href="<?php echo base_url(). ASSETS_PLUGINS; ?>dropify/dist/css/dropify.min.css">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="<?= base_url(set_session('photo')); ?>" alt="user" class="profile-pic" />
                            </a>
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            <div class="u-img"><img src="<?= base_url(set_session('photo')); ?>" alt=""></div>
                                            <div class="u-text">
                                                <h4><?= set_session('username_login'); ?></h4>
                                        </div>
                                    </li>
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor"><?= (isset($breadcrumb)) ? $breadcrumb : ""; ?></h3>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                            <li class="breadcrumb-item active"><?= (isset($breadcrumb_child)) ? $breadcrumb_child : ""; ?></li>
                        </ol>
                    </div>
                </div>
                <!-- ============================================================== -->
